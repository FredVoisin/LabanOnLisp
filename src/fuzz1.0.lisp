...
(defclass FUZZELEMENT (fuzzy)
  ()
  (:documentation "Defines allfuzzy elemnts as subset of fuzzy conceptual space."))

(defclass FUZZNUM (fuzzelement)
  ()
  (:documentation "Defines all fuzzy numbers as subset of fuzzy elements."))
...
(defclass D-FUZZNUM (fuzznum)
  ()
  (:documentation "Defines DISCRETE fuzzy numbers as subset of fuzzy numbers.
To be distinguish to C-FUZZNUM."))

(defclass OPEN-D-FUZZNUM (d-fuzznum)
  ((name
    :initarg :name
    :reader name
    :initform ""
  ...
  (:documentation "Defines OPEN discrete fuzzy numbers."))

(defclass PEAK-D-FUZZNUM (d-fuzznum)
  ((name
    :initarg :name
    :reader name
    :initform ""
   ...
   (fmax
    ...
    :accessor fmax
    :type number))
  (:documentation "Sub-Class of discrete fuzzy numbers
defined by one membership value and min and max values."))

(defclass RANGE-D-FUZZNUM (d-fuzznum)
  ((name
    :initarg :name
    :reader name
    :initform ""
   ...
   (frange
    ...
    :type number))
  (:documentation "Sub-Class of discrete fuzzy numbers
defined by two membership values (value +- 1/2 range) and min and max values."))
